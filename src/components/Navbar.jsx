...
function Navbar() {
  ...
  return (
    <>
    <div className="hidden sm:block absolute top-8.5 left-8">
    ...
    <nav className="absolute top-8 left-4 sm:left-1/2 sm:-translate-x-1/2">
    ...
    <a className="hidden sm:block absolute top-8.5 right-8">
